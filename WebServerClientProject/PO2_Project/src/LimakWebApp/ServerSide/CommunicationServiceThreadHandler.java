...
public class CommunicationServiceThreadHandler extends ServicesHandler {
     ...
     */
    public CommunicationServiceThreadHandler(SocketHandler handler, CredentialPacket packet, String ID, Controller controller) throws IOException{
        super(handler, ((AbstractServerController)controller).getCredentialPacket(), ID);
